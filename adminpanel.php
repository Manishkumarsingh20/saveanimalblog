            ...
            <div class="row py-4 my-5">
                ...
                <div class="col-sm-4 my-5">
                    <form method="post">
                        <!-- email start -->
                        <div class="form-floating mb-3">
                            <input name="email" type="text" class="form-control" value= "<?php if(isset($_POST['login'])) { echo $_POST['email']; } ?>" onkeyup="return validateadmit()" autocomplete="off" id="floatingInput" placeholder="name@example.com">
